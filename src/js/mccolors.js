/*
 * Copyright (c) https://github.com/FoxInFlame/MinecraftColorCodes
 */
...
function obfuscate(string, elem) {
  ...
  function replaceRand(string, i) {
    const randChar = String.fromCharCode(randInt(64, 90));
...
export default function replaceColorCodes(str) {
  clearObfuscators();
  const frag = parseStyle(String(str));
