    ...
    return (
      <div id="header">
        <div className="site-title">
          ...
          <small>v</small>
          2
          <div className="subtitle">Written by <a href='http://ref.emc.gs/?gas=timingsphp' rel="nofollow">Aikar</a>
          </div>
        </div>
        ...
        <div id="header-right" className="section">
          <div className="section-head">
            ...
            <span className="section-controls">
              ...
              &nbsp;
              <a className="normal"
                 href="https://www.paypal.com/cgi-bin/webscr?cmd=_donations&business=payments%40starlis%2ecom&lc=US&item_name=Aikar%20Timings&no_note=0&currency_code=USD&bn=PP%2dDonationsBF%3abtn_donate_SM%2egif%3aNonHostedGuest"><i
                className="fa fa-paypal"/> Donate</a>
				</span>
          </div>
